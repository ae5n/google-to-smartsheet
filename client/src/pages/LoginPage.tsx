      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Securely transfer your Google Sheets data to Smartsheet with image preservation
          </p>
        </div>
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <div className="space-y-6">
              ...
              <div className="text-xs text-center text-gray-500">
                By signing in, you agree to our secure handling of your data.
                We only access the spreadsheets you explicitly choose to transfer.
              </div>
            </div>
          </div>
        </div>
